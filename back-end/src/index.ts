...
app.post('/api/dashboard/data', DashboardController.getDashboardData);
app.get('/api/dashboard/data', DashboardController.getDashboardData); // Allow GET for easier debugging/caching if needed
