...
export const mockEstoque: EstoqueItem[] = [
  {
    ...
    materiaPrima: mockMateriasPrimas[0]
  },
  {
    id: '2',
    materia_prima_id: '2',
    ...
    materiaPrima: mockMateriasPrimas[1]
  },
  {
    id: '3',
    materia_prima_id: '3',
    ...
    materiaPrima: mockMateriasPrimas[2]
  },
  {
    id: '4',
    materia_prima_id: '4',
    ...
    materiaPrima: mockMateriasPrimas[3]
  },
  {
    id: '5',
    materia_prima_id: '5',
    ...
    materiaPrima: mockMateriasPrimas[4]
  }
];

// Mock movimentações de estoque
export const mockMovimentacoes: MovimentacaoEstoqueItem[] = [
  {
    id: '1',
    materia_prima_id: '1',
    tipo: 'entrada',
