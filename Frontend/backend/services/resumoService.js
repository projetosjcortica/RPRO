...
const materiaPrimaService_1 = require("./materiaPrimaService");
class ResumoService {
    /**
     * Aplica filtro de fórmula ao query builder
     */
    applyFormulaFilter(qb, formula) {
    ...
    getResumo(filtros) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allRows = yield qbFull.getMany();
            // Buscar informações completas dos produtos da MateriaPrima
            const materiasPrimas = yield materiaPrimaService_1.materiaPrimaService.getAll();
            const infosProdutos = {};
            ...
            const usosPorProduto = {};
            const formulasUtilizadas = {};
            let totalPesos = 0;
    ...
    processResumo(relatorios, areaId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const relatorio of dadosFiltrados) {
                ...
                let rowTotalKg = 0;
                for (let i = 1; i <= 40; i++) {
                    const prodValue = relatorio[`Prod_${i}`];
...
//# sourceMappingURL=resumoService.js.map