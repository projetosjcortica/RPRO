...
function returnResults(it) {
  ...
  if (schemaEnv.$async) {
    gen.if((0, codegen_1$Q._)`${names_1$9.default.errors} === 0`, () => gen.return(names_1$9.default.data), () => gen.throw((0, codegen_1$Q._)`new ${ValidationError2}(${names_1$9.default.vErrors})`));
  } else {
