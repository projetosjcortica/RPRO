...
var jr = (e, t, r) => Su(e, typeof t != "symbol" ? t + "" : t, r), si = (e, t, r) => t.has(e) || ni("Cannot " + r);
var $e = (e, t, r) => (si(e, t, "read from private field"), r ? r.call(e) : t.get(e)), kr = (e, t, r) => t.has(e) ? ni("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Tr = (e, t, r, n) => (si(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r);
import Tc, { ipcMain as at, dialog as Ac, BrowserWindow as na, app as Vt } from "electron";
...
import { fork as Qn, spawn as Ou } from "child_process";
const xt = (e) => {
  const t = typeof e;
...
function ai(e, t, r) {
  ...
  for (let a = 0; a < s.length; a++) {
    const o = s[a];
    Cc(e, o), a === s.length - 1 ? e[o] = r : xt(e[o]) || (e[o] = typeof s[a + 1] == "number" ? [] : {}), e = e[o];
  }
  return n;
}
function ku(e, t) {
...
const At = Yn.homedir(), aa = Yn.tmpdir(), { env: dr } = Pe, Au = (e) => {
  ...
  const t = dr.APPDATA || ue.join(At, "AppData", "Roaming"), r = dr.LOCALAPPDATA || ue.join(At, "AppData", "Local");
  return {
  ...
  return {
    data: ue.join(dr.XDG_DATA_HOME || ue.join(At, ".local", "share"), e),
    config: ue.join(dr.XDG_CONFIG_HOME || ue.join(At, ".config"), e),
    cache: ue.join(dr.XDG_CACHE_HOME || ue.join(At, ".cache"), e),
    // https://wiki.debian.org/XDGBaseDirectorySpecification#state
    log: ue.join(dr.XDG_STATE_HOME || ue.join(At, ".local", "state"), e),
    temp: ue.join(aa, t, e)
  };
};
...
const zu = new Fu(), Nt = (e, t) => function(n) {
  ...
  attempt: {
    /* ASYNC */
    chmod: Pt(Ae(ae.chmod), ye.onChangeError),
    chown: Pt(Ae(ae.chown), ye.onChangeError),
    close: Pt(Ae(ae.close), Ke),
    fsync: Pt(Ae(ae.fsync), Ke),
    mkdir: Pt(Ae(ae.mkdir), Ke),
    realpath: Pt(Ae(ae.realpath), Ke),
    stat: Pt(Ae(ae.stat), Ke),
    unlink: Pt(Ae(ae.unlink), Ke),
    /* SYNC */
    chmodSync: pt(ae.chmodSync, ye.onChangeError),
    chownSync: pt(ae.chownSync, ye.onChangeError),
    closeSync: pt(ae.closeSync, Ke),
    existsSync: pt(ae.existsSync, Ke),
    fsyncSync: pt(ae.fsync, Ke),
    mkdirSync: pt(ae.mkdirSync, Ke),
    realpathSync: pt(ae.realpathSync, Ke),
    statSync: pt(ae.statSync, Ke),
    unlinkSync: pt(ae.unlinkSync, Ke)
  },
  retry: {
    /* ASYNC */
    close: Nt(Ae(ae.close), ye.isRetriableError),
    fsync: Nt(Ae(ae.fsync), ye.isRetriableError),
    open: Nt(Ae(ae.open), ye.isRetriableError),
    readFile: Nt(Ae(ae.readFile), ye.isRetriableError),
    rename: Nt(Ae(ae.rename), ye.isRetriableError),
    stat: Nt(Ae(ae.stat), ye.isRetriableError),
    write: Nt(Ae(ae.write), ye.isRetriableError),
    writeFile: Nt(Ae(ae.writeFile), ye.isRetriableError),
    /* SYNC */
    closeSync: Rt(ae.closeSync, ye.isRetriableError),
    fsyncSync: Rt(ae.fsyncSync, ye.isRetriableError),
    openSync: Rt(ae.openSync, ye.isRetriableError),
    readFileSync: Rt(ae.readFileSync, ye.isRetriableError),
    renameSync: Rt(ae.renameSync, ye.isRetriableError),
    statSync: Rt(ae.statSync, ye.isRetriableError),
    writeSync: Rt(ae.writeSync, ye.isRetriableError),
    writeFileSync: Rt(ae.writeFileSync, ye.isRetriableError)
  }
}, Uu = "utf8", oi = 438, qu = 511, Gu = {}, Ku = Yn.userInfo().uid, Hu = Yn.userInfo().gid, Bu = 1e3, Ju = !!Pe.getuid;
Pe.getuid && Pe.getuid();
const ii = 128, Wu = (e) => e instanceof Error && "code" in e, ci = (e) => typeof e == "string", _s = (e) => e === void 0, Xu = Pe.platform === "linux", Dc = Pe.platform === "win32", oa = ["SIGABRT", "SIGALRM", "SIGHUP", "SIGINT", "SIGTERM"];
Dc || oa.push("SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
    ...
    this.callbacks = /* @__PURE__ */ new Set(), this.exited = !1, this.exit = (t) => {
      if (!this.exited) {
        ...
        for (const r of this.callbacks)
          r();
        t && (Dc && t !== "SIGINT" && t !== "SIGTERM" && t !== "SIGKILL" ? Pe.kill(Pe.pid, "SIGTERM") : Pe.kill(Pe.pid, t));
      }
    }, this.hook = () => {
...
function Mc(e, t, r = Gu) {
  ...
  try {
    ...
    const d = Ju && _s(r.chown), u = _s(r.mode);
    if (l && (d || u)) {
...
var Ls = { exports: {} }, Vc = {}, $t = {}, Kt = {}, en = {}, re = {}, Zr = {};
(function(e) {
...
function ld() {
  if (fi) return Kt;
  fi = 1, Object.defineProperty(Kt, "__esModule", { value: !0 }), Kt.boolOrEmptySchema = Kt.topBoolOrEmptySchema = void 0;
  const e = en, t = re, r = ot(), n = {
...
vt.schemaHasRulesForType = md;
function Kc(e, t) {
  return t.rules.some((r) => Hc(e, r));
}
vt.shouldUseGroup = Kc;
function Hc(e, t) {
  var r;
...
const pd = er, $d = vt, yd = en, ne = re, Bc = L;
var fr;
(function(e) {
...
be.getJSONTypes = Jc;
function _d(e, t) {
  const { gen: r, data: n, opts: s } = e, a = vd(t, s.coerceTypes), o = t.length > 0 && !(a.length === 0 && t.length === 1 && (0, $d.schemaHasRulesForType)(e, t[0]));
  if (o) {
    const c = la(t, n, s.strictNumbers, fr.Wrong);
    r.if(c, () => {
      a.length ? wd(e, t, a) : ua(e);
    });
  }
  return o;
}
...
function Pd() {
  if (hi) return Cr;
  hi = 1, Object.defineProperty(Cr, "__esModule", { value: !0 }), Cr.assignDefaults = void 0;
  const e = re, t = L;
  function r(s, a) {
...
ie.checkReportMissingProp = Rd;
function Od({ gen: e, data: t, it: { opts: r } }, n, s) {
  return (0, me.or)(...n.map((a) => (0, me.and)(ha(e, t, a, r.ownProperties), (0, me._)`${s} = ${a}`)));
}
ie.checkMissingProp = Od;
function Id(e, t) {
  e.setParams({ missingProperty: t }, !0), e.error();
}
ie.reportMissingProp = Id;
function Xc(e) {
  return e.scopeValue("func", {
...
ie.allSchemaProperties = Yc;
function kd(e, t) {
  return Yc(t).filter((r) => !(0, da.alwaysValidSchema)(e, t[r]));
}
ie.schemaProperties = kd;
function Td({ schemaCode: e, data: t, it: { gen: r, topSchemaRef: n, schemaPath: s, errorPath: a }, it: o }, c, l, d) {
...
ie.callValidateCode = Td;
const Ad = (0, me._)`new RegExp`;
function Cd({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, a = s(r, n);
  return e.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, me._)`${s.code === "new RegExp" ? Ad : (0, Nd.useFunc)(e, s)}(${r}, ${n})`
  });
}
ie.usePattern = Cd;
function Dd(e) {
...
function Ld() {
  if (mi) return Ye;
  mi = 1, Object.defineProperty(Ye, "__esModule", { value: !0 }), Ye.validateKeywordUsage = Ye.validSchemaType = Ye.funcKeywordCode = Ye.macroKeywordCode = void 0;
  const e = re, t = ot(), r = ie, n = en;
  function s(w, $) {
    ...
    for (var u in n) {
      ...
      if (Array.isArray(h)) {
        ...
        if (h && typeof h == "object")
          for (var $ in h)
            Rn(e, t, r, h[$], s + "/" + u + "/" + Fd($), a, s, u, n, $);
      } else (u in Dt.keywords || e.allKeys && !(u in Dt.skipKeywords)) && Rn(e, t, r, h, s + "/" + u, a, s, u, n);
    }
    r(n, s, a, o, c, l, d);
  }
}
...
const Ud = L, qd = xn, Gd = zd, Kd = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function Hd(e, t = !0) {
  return typeof e == "boolean" ? !0 : t === !0 ? !Us(e) : t ? Zc(e) <= t : !1;
}
je.inlineRef = Hd;
...
function Zc(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !Kd.has(r) && (typeof e[r] == "object" && (0, Ud.eachItem)(e[r], (n) => t += Zc(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
je.resolveUrl = Wd;
const Xd = /^[a-z_][-a-z0-9._]*$/i;
function Yd(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = hr(e[r] || t), a = { "": s }, o = xc(n, s, !1), c = {}, l = /* @__PURE__ */ new Set();
  return Gd(e, { allKeys: !0 }, (h, w, $, y) => {
    if (y === void 0)
      return;
    const g = o + w;
    let _ = a[y];
...
function es() {
  if ($i) return $t;
  $i = 1, Object.defineProperty($t, "__esModule", { value: !0 }), $t.getData = $t.KeywordCxt = $t.validateFunctionCode = void 0;
  const e = ld(), t = be, r = vt, n = be, s = Pd(), a = Ld(), o = Vd(), c = re, l = ot(), d = je, u = L, h = en;
  function w(R) {
    if (j(R) && (Y(R), O(R))) {
      _(R);
      return;
...
const Qe = re, xd = tn, Ht = ot(), tt = je, yi = L, ef = es();
let ts = class {
  constructor(t) {
    var r;
...
function ma(e) {
  ...
  let u;
  try {
    this._compilations.add(e), (0, ef.validateFunctionCode)(d), o.optimize(this.opts.code.optimize);
    const h = o.toString();
    u = `${o.scopeRefs(Ht.default.scope)}return ${h}`, this.opts.code.process && (u = this.opts.code.process(u, e));
    const $ = new Function(`${Ht.default.self}`, `${Ht.default.scope}`, u)(this, this.scope.get());
...
Fe.resolveRef = tf;
function rf(e) {
  return (0, tt.inlineRef)(e.schema, this.opts.inlineRefs) ? e.schema : e.validate ? e : ma.call(this, e);
}
function tl(e) {
...
function rs(e, t) {
  ...
  if (typeof o == "string") {
    ...
    return typeof (c == null ? void 0 : c.schema) != "object" ? void 0 : ws.call(this, r, c);
  }
  if (typeof (o == null ? void 0 : o.schema) == "object") {
    if (o.validate || ma.call(this, o), a === (0, tt.normalizeId)(t)) {
      const { schema: c } = o, { schemaId: l } = this.opts, d = c[l];
      return d && (s = (0, tt.resolveUrl)(this.opts.uriResolver, s, d)), new ts({ schema: c, schemaId: l, root: e, baseId: s });
    }
...
function ws(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const c of e.fragment.slice(1).split("/")) {
    ...
    !af.has(c) && d && (t = (0, tt.resolveUrl)(this.opts.uriResolver, t, d));
  }
  let a;
...
const of = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", cf = "Meta-schema for $data reference (JSON AnySchema extension proposal)", lf = "object", uf = [
  "$data"
], df = {
  $data: {
    type: "string",
  ...
  required: uf,
  properties: df,
  additionalProperties: ff
};
var pa = {}, ns = { exports: {} };
const mf = RegExp.prototype.test.bind(/^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu), rl = RegExp.prototype.test.bind(/^(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)$/u);
function nl(e) {
  let t = "", r = 0, n = 0;
...
const pf = RegExp.prototype.test.bind(/[^!"$&'()*+,\-.;=_`a-z{}~]/u);
function gi(e) {
  return e.length = 0, !0;
}
function $f(e, t, r) {
...
function yf(e) {
  ...
  return s.length && (c === gi ? r.zone = s.join("") : o ? n.push(s.join("")) : n.push(nl(s))), r.address = n.join(""), r;
}
function sl(e) {
  if (gf(e, ":") < 2)
...
var al = {
  ...
  normalizeComponentEncoding: vf,
  removeDotSegments: _f,
  isIPv4: rl,
  isUUID: mf,
  normalizeIPv6: sl
};
const { isUUID: Ef } = al, bf = /([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu;
function ol(e) {
...
function Of(e, t) {
  const r = e;
  return r.uuid = r.nss, r.nss = void 0, !t.tolerant && (!r.uuid || !Ef(r.uuid)) && (r.error = r.error || "UUID is not valid."), r;
}
function If(e) {
  const t = e;
...
const { normalizeIPv6: Df, removeDotSegments: Fr, recomposeAuthority: Mf, normalizeComponentEncoding: ln, isIPv4: Lf, nonSimpleDomain: Vf } = al, { SCHEMES: Ff, getSchemeHandler: ul } = Cf;
function zf(e, t) {
  return typeof e == "string" ? e = /** @type {T} */
  ft(bt(e, t), t) : typeof e == "object" && (e = /** @type {T} */
  bt(ft(e, t), t)), e;
}
function Uf(e, t, r) {
...
function dl(e, t, r, n) {
  const s = {};
  return n || (e = bt(ft(e, r), r), t = bt(ft(t, r), r)), r = r || {}, !r.tolerant && t.scheme ? (s.scheme = t.scheme, s.userinfo = t.userinfo, s.host = t.host, s.port = t.port, s.path = Fr(t.path || ""), s.query = t.query) : (t.userinfo !== void 0 || t.host !== void 0 || t.port !== void 0 ? (s.userinfo = t.userinfo, s.host = t.host, s.port = t.port, s.path = Fr(t.path || ""), s.query = t.query) : (t.path ? (t.path[0] === "/" ? s.path = Fr(t.path) : ((e.userinfo !== void 0 || e.host !== void 0 || e.port !== void 0) && !e.path ? s.path = "/" + t.path : e.path ? s.path = e.path.slice(0, e.path.lastIndexOf("/") + 1) + t.path : s.path = t.path, s.path = Fr(s.path)), s.query = t.query) : (s.path = e.path, t.query !== void 0 ? s.query = t.query : s.query = e.query), s.userinfo = e.userinfo, s.host = e.host, s.port = e.port), s.scheme = e.scheme), s.fragment = t.fragment, s;
}
function qf(e, t, r) {
  return typeof e == "string" ? (e = unescape(e), e = ft(ln(bt(e, r), !0), { ...r, skipEscape: !0 })) : typeof e == "object" && (e = ft(ln(e, !0), { ...r, skipEscape: !0 })), typeof t == "string" ? (t = unescape(t), t = ft(ln(bt(t, r), !0), { ...r, skipEscape: !0 })) : typeof t == "object" && (t = ft(ln(t, !0), { ...r, skipEscape: !0 })), e.toLowerCase() === t.toLowerCase();
}
function ft(e, t) {
  const r = {
    host: e.host,
...
function bt(e, t) {
  ...
  if (a) {
    ...
    if (!r.unicodeSupport && (!o || !o.unicodeSupport) && n.host && (r.domainHost || o && o.domainHost) && s === !1 && Vf(n.host))
      try {
...
ns.exports = ya;
ns.exports.default = ya;
ns.exports.fastUri = ya;
var fl = ns.exports;
...
(function(e) {
  ...
  const n = tn, s = _r, a = er, o = Fe, c = re, l = je, d = be, u = L, h = hf, w = pa, $ = (N, p) => new RegExp(N, p);
  $.code = "new RegExp";
  ...
  function P(N) {
    ...
    const Xe = N.strict, Gt = (p = N.code) === null || p === void 0 ? void 0 : p.optimize, Or = Gt === !0 || Gt === void 0 ? 1 : Gt || 0, Ir = (v = (S = N.code) === null || S === void 0 ? void 0 : S.regExp) !== null && v !== void 0 ? v : $, ys = (i = N.uriResolver) !== null && i !== void 0 ? i : w.default;
    return {
      strictSchema: (b = (f = N.strictSchema) !== null && f !== void 0 ? f : Xe) !== null && b !== void 0 ? b : !0,
      strictNumbers: (A = (T = N.strictNumbers) !== null && T !== void 0 ? T : Xe) !== null && A !== void 0 ? A : !0,
...
const Hf = _r, _i = ie, Ue = re, nr = ot(), vi = Fe, un = L, Bf = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    ...
    if (u === void 0)
      throw new Hf.default(n.opts.uriResolver, s, r);
...
function In(e, t, r, n) {
  ...
  function u() {
    ...
    const y = s.let("valid");
    s.try(() => {
      s.code((0, Ue._)`await ${(0, _i.callValidateCode)(e, t, d)}`), $(t), o || s.assign(y, !0);
    }, (g) => {
      s.if((0, Ue._)`!(${g} instanceof ${a.ValidationError})`, () => s.throw(g)), w(g), o || s.assign(y, !1);
    }), e.ok(y);
  }
  function h() {
    e.result((0, _i.callValidateCode)(e, t, d), () => $(t), () => w(t));
  }
  function w(y) {
  ...
  function $(y) {
    ...
    if (a.props !== !0)
      if (_ && !_.dynamicProps)
        ...
        a.props = un.mergeEvaluated.props(s, m, a.props, Ue.Name);
      }
    if (a.items !== !0)
      if (_ && !_.dynamicItems)
        ...
        a.items = un.mergeEvaluated.items(s, m, a.items, Ue.Name);
      }
  }
}
St.callRef = In;
...
const zn = re, It = zn.operators, Un = {
...
const Jt = re, eh = L, th = Pa, rh = {
  ...
  error: rh,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? Jt.operators.GT : Jt.operators.LT, o = s.opts.unicode === !1 ? (0, Jt._)`${r}.length` : (0, Jt._)`${(0, eh.useFunc)(e.gen, th.default)}(${r})`;
...
const sh = ie, qn = re, ah = {
  ...
  error: ah,
  code(e) {
    const { data: t, $data: r, schema: n, schemaCode: s, it: a } = e, o = a.opts.unicodeRegExp ? "u" : "", c = r ? (0, qn._)`(new RegExp(${s}, ${o}))` : (0, sh.usePattern)(e, n);
    ...
    if (o.allErrors ? d() : u(), c.strictRequired) {
      ...
      for (const g of r)
        if (($ == null ? void 0 : $[g]) === void 0 && !y.has(g)) {
          ...
          (0, lh.checkStrictMode)(o, m, o.opts.strictRequired);
        }
    }
    function d() {
      if (l || a)
...
const Es = be, Oe = re, mh = L, ph = rn, $h = {
  ...
  code(e) {
    ...
    if (!n && !s)
      return;
    const l = t.let("valid"), d = a.items ? (0, Es.getSchemaTypes)(a.items) : [];
    ...
    function w(y, g) {
      const _ = t.name("item"), m = (0, Es.checkDataTypes)(d, _, c.opts.strictNumbers, Es.DataType.Wrong), E = t.const("indices", (0, Oe._)`{}`);
      t.for((0, Oe._)`;${y}--;`, () => {
    ...
    function $(y, g) {
      const _ = (0, mh.useFunc)(t, ph.default), m = t.name("outer");
...
const qs = re, gh = L, _h = rn, vh = {
  ...
  code(e) {
    ...
    n || a && typeof a == "object" ? e.fail$data((0, qs._)`!${(0, gh.useFunc)(t, _h.default)}(${r}, ${s})`) : e.fail((0, qs._)`${a} !== ${r}`);
  }
};
ka.default = wh;
var Ta = {};
Object.defineProperty(Ta, "__esModule", { value: !0 });
const zr = re, Eh = L, bh = rn, Sh = {
  ...
  code(e) {
    ...
    let l;
    const d = () => l ?? (l = (0, Eh.useFunc)(t, bh.default));
    let u;
    if (c || n)
...
const Nh = Ea, Rh = ba, Oh = Sa, Ih = Na, jh = Ra, kh = Oa, Th = Ia, Ah = ja, Ch = ka, Dh = Ta, Mh = [
  // number
  Nh.default,
  Rh.default,
  // string
...
function yl(e, t) {
  ...
  o.items = !0;
  const c = r.const("len", (0, Wt._)`${s}.length`);
  if (n === !1)
    e.setParams({ len: t.length }), e.pass((0, Wt._)`${c} <= ${t.length}`);
  else if (typeof n == "object" && !(0, Gs.alwaysValidSchema)(o, n)) {
    const d = r.var("valid", (0, Wt._)`${c} <= ${t.length}`);
    r.if((0, Wt.not)(d), () => l(d)), e.ok(d);
  }
  function l(d) {
    r.forRange("i", t.length, c, (u) => {
      e.subschema({ keyword: a, dataProp: u, dataPropType: Gs.Type.Num }, d), o.allErrors || r.if((0, Wt.not)(d), () => r.break());
    });
  }
}
...
const wi = re, jn = L, Fh = ie, zh = {
  ...
  code(e) {
    ...
    r.items = !0, !(0, jn.alwaysValidSchema)(r, t) && e.ok((0, Fh.validateArray)(e));
  }
};
function gl(e, t, r = e.schema) {
  ...
  r.forEach((h, w) => {
    (0, jn.alwaysValidSchema)(c, h) || (n.if((0, wi._)`${d} > ${w}`, () => e.subschema({
      keyword: o,
      schemaProp: w,
      dataProp: w
    }, l)), e.ok(l));
...
const Ei = re, Gh = L, Kh = ie, Hh = vr, Bh = {
  ...
  code(e) {
    ...
    n.items = !0, !(0, Gh.alwaysValidSchema)(n, t) && (s ? (0, Hh.validateAdditionalItems)(e, s) : e.ok((0, Kh.validateArray)(e)));
  }
};
Da.default = Jh;
var Ma = {};
...
const fn = ie, xe = re, xh = ot(), hn = L, em = {
  ...
  code(e) {
    ...
    h(), e.ok((0, xe._)`${a} === ${xh.default.errors}`);
    function h() {
      t.forIn("key", s, (_) => {
    ...
    function w(_) {
      let m;
      if (d.length > 8) {
        const E = (0, hn.schemaRefOrVal)(o, n.properties, "properties");
...
var Va = {};
Object.defineProperty(Va, "__esModule", { value: !0 });
const rm = es(), bi = ie, bs = L, Si = as, nm = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: a } = e;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && Si.default.code(new rm.KeywordCxt(a, Si.default, "additionalProperties"));
...
const Pi = ie, mn = re, Ni = L, Ri = L, sm = {
  ...
  code(e) {
    ...
    function $(g) {
      for (const _ in d)
        new RegExp(g).test(_) && (0, Ni.checkStrictMode)(a, `property ${_} matches pattern ${g} (use allowMatchingProperties)`);
    }
    function y(g) {
      t.forIn("key", n, (_) => {
        t.if((0, mn._)`${(0, Pi.usePattern)(e, g)}.test(${_})`, () => {
...
const kn = re, lm = L, um = {
  ...
  code(e) {
    ...
    function d() {
      a.forEach((u, h) => {
        let w;
        (0, lm.alwaysValidSchema)(s, u) ? t.var(l, !0) : w = e.subschema({
          keyword: "oneOf",
          schemaProp: h,
          compositeRule: !0
...
const $m = L, ym = {
  ...
  code({ keyword: e, parentSchema: t, it: r }) {
    t.if === void 0 && (0, $m.checkStrictMode)(r, `"${e}" without "if" is ignored`);
  }
};
Ha.default = ym;
Object.defineProperty(Aa, "__esModule", { value: !0 });
const gm = vr, _m = Ca, vm = wr, wm = Da, Em = Ma, bm = ss, Sm = La, Pm = as, Nm = Va, Rm = Fa, Om = za, Im = Ua, jm = qa, km = Ga, Tm = Ka, Am = Ha;
function Cm(e = !1) {
  const t = [
    // any
    Om.default,
  ...
  return e ? t.push(_m.default, wm.default) : t.push(gm.default, vm.default), t.push(Em.default), t;
}
Aa.default = Cm;
var Ba = {}, Er = {};
Object.defineProperty(Er, "__esModule", { value: !0 });
Er.dynamicAnchor = void 0;
const Ss = re, Dm = ot(), Ii = Fe, Mm = St, Lm = {
...
function wl(e, t) {
  ...
  const s = (0, Ss._)`${Dm.default.dynamicAnchors}${(0, Ss.getProperty)(t)}`, a = n.errSchemaPath === "#" ? n.validateName : Vm(e);
...
function Vm(e) {
  ...
  return Ii.compileSchema.call(n, d), (0, Mm.getValidate)(e, d);
}
Er.default = Lm;
var br = {};
Object.defineProperty(br, "__esModule", { value: !0 });
br.dynamicRef = void 0;
const ji = re, Fm = ot(), ki = St, zm = {
  keyword: "$dynamicRef",
  schemaType: "string",
...
function El(e, t) {
  ...
  function o(l) {
    if (s.schemaEnv.root.dynamicAnchors[a]) {
      const d = r.let("_v", (0, ji._)`${Fm.default.dynamicAnchors}${(0, ji.getProperty)(a)}`);
...
const Um = Er, qm = L, Gm = {
  ...
  schemaType: "boolean",
  code(e) {
    e.schema ? (0, Um.dynamicAnchor)(e, "") : (0, qm.checkStrictMode)(e.it, "$recursiveAnchor: false is ignored");
  }
};
Ja.default = Gm;
var Wa = {};
...
const Km = br, Hm = {
  ...
  schemaType: "string",
  code: (e) => (0, Km.dynamicRef)(e, e.schema)
};
Wa.default = Hm;
Object.defineProperty(Ba, "__esModule", { value: !0 });
const Bm = Er, Jm = br, Wm = Ja, Xm = Wa, Ym = [Bm.default, Jm.default, Wm.default, Xm.default];
Ba.default = Ym;
var Xa = {}, Ya = {};
...
const Ti = ss, Qm = {
  ...
  schemaType: "object",
  error: Ti.error,
  code: (e) => (0, Ti.validatePropertyDeps)(e)
};
Ya.default = Qm;
var Qa = {};
Object.defineProperty(Qa, "__esModule", { value: !0 });
const Zm = ss, xm = {
  ...
  type: "object",
  schemaType: "object",
  code: (e) => (0, Zm.validateSchemaDeps)(e)
};
Qa.default = xm;
var Za = {};
Object.defineProperty(Za, "__esModule", { value: !0 });
const ep = L, tp = {
  ...
  schemaType: "number",
  code({ keyword: e, parentSchema: t, it: r }) {
    t.contains === void 0 && (0, ep.checkStrictMode)(r, `"${e}" without "contains" is ignored`);
  }
};
Za.default = tp;
Object.defineProperty(Xa, "__esModule", { value: !0 });
const rp = Ya, np = Qa, sp = Za, ap = [rp.default, np.default, sp.default];
Xa.default = ap;
var xa = {}, eo = {};
Object.defineProperty(eo, "__esModule", { value: !0 });
const Tt = re, Ai = L, op = ot(), ip = {
  ...
  code(e) {
    ...
    c instanceof Tt.Name ? t.if((0, Tt._)`${c} !== true`, () => t.forIn("key", n, (h) => t.if(d(c, h), () => l(h)))) : c !== !0 && t.forIn("key", n, (h) => c === void 0 ? l(h) : t.if(u(c, h), () => l(h))), a.props = !0, e.ok((0, Tt._)`${s} === ${op.default.errors}`);
    function l(h) {
      if (r === !1) {
...
const Xt = re, Ci = L, lp = {
  ...
  code(e) {
    ...
    if (r === !1)
      ...
      t.if((0, Xt.not)(l), () => c(l, a)), e.ok(l);
    }
    s.items = !0;
    function c(l, d) {
      t.forRange("i", d, o, (u) => {
        e.subschema({ keyword: "unevaluatedItems", dataProp: u, dataPropType: Ci.Type.Num }, l), s.allErrors || t.if((0, Xt.not)(l), () => t.break());
      });
    }
  }
};
to.default = up;
Object.defineProperty(xa, "__esModule", { value: !0 });
const dp = eo, fp = to, hp = [dp.default, fp.default];
xa.default = hp;
var ro = {}, no = {};
...
Object.defineProperty(ga, "__esModule", { value: !0 });
const gp = _a, _p = wa, vp = Aa, wp = Ba, Ep = Xa, bp = xa, Sp = ro, Di = $r, Pp = [
  wp.default,
  gp.default,
  _p.default,
  (0, vp.default)(!0),
...
const lr = re, Ks = os, Li = Fe, Np = _r, Rp = L, Op = {
  ...
  code(e) {
    ...
    function w() {
      ...
      for (let O = 0; O < o.length; O++) {
        let j = o[O];
        if (j != null && j.$ref && !(0, Rp.schemaHasRulesButRef)(j, a.self.RULES)) {
          const Y = j.$ref;
          if (j = Li.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, Y), j instanceof Li.SchemaEnv && (j = j.schema), j === void 0)
            throw new Np.default(a.opts.uriResolver, a.baseId, Y);
        }
...
so.default = Ip;
var ao = {};
const jp = "https://json-schema.org/draft/2020-12/schema", kp = "https://json-schema.org/draft/2020-12/schema", Tp = {
...
}, Ap = "meta", Cp = "Core and Validation specifications meta-schema", Dp = [
  {
    $ref: "meta/core"
  },
  {
  ...
  "object",
  "boolean"
], Lp = "This meta-schema also defines keywords that have appeared in previous drafts in order to prevent incompatible extensions as they remain in common use.", Vp = {
  definitions: {
  ...
  $comment: Lp,
  properties: Vp
}, zp = "https://json-schema.org/draft/2020-12/schema", Up = "https://json-schema.org/draft/2020-12/meta/applicator", qp = {
  "https://json-schema.org/draft/2020-12/vocab/applicator": !0
}, Gp = "meta", Kp = "Applicator vocabulary meta-schema", Hp = [
  "object",
  "boolean"
], Bp = {
  prefixItems: {
  ...
  properties: Bp,
  $defs: Jp
}, Xp = "https://json-schema.org/draft/2020-12/schema", Yp = "https://json-schema.org/draft/2020-12/meta/unevaluated", Qp = {
  "https://json-schema.org/draft/2020-12/vocab/unevaluated": !0
}, Zp = "meta", xp = "Unevaluated applicator vocabulary meta-schema", e$ = [
  "object",
  "boolean"
], t$ = {
  unevaluatedItems: {
  ...
  type: e$,
  properties: t$
}, n$ = "https://json-schema.org/draft/2020-12/schema", s$ = "https://json-schema.org/draft/2020-12/meta/content", a$ = {
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, o$ = "meta", i$ = "Content vocabulary meta-schema", c$ = [
  "object",
  "boolean"
], l$ = {
  contentEncoding: {
  ...
  type: c$,
  properties: l$
}, d$ = "https://json-schema.org/draft/2020-12/schema", f$ = "https://json-schema.org/draft/2020-12/meta/core", h$ = {
  "https://json-schema.org/draft/2020-12/vocab/core": !0
}, m$ = "meta", p$ = "Core vocabulary meta-schema", $$ = [
  "object",
  "boolean"
], y$ = {
  $id: {
  ...
  properties: y$,
  $defs: g$
}, v$ = "https://json-schema.org/draft/2020-12/schema", w$ = "https://json-schema.org/draft/2020-12/meta/format-annotation", E$ = {
  "https://json-schema.org/draft/2020-12/vocab/format-annotation": !0
}, b$ = "meta", S$ = "Format vocabulary meta-schema for annotation results", P$ = [
  "object",
  "boolean"
], N$ = {
  format: {
  ...
  type: P$,
  properties: N$
}, O$ = "https://json-schema.org/draft/2020-12/schema", I$ = "https://json-schema.org/draft/2020-12/meta/meta-data", j$ = {
  "https://json-schema.org/draft/2020-12/vocab/meta-data": !0
}, k$ = "meta", T$ = "Meta-data vocabulary meta-schema", A$ = [
  "object",
  "boolean"
], C$ = {
  title: {
  ...
  type: A$,
  properties: C$
}, M$ = "https://json-schema.org/draft/2020-12/schema", L$ = "https://json-schema.org/draft/2020-12/meta/validation", V$ = {
  "https://json-schema.org/draft/2020-12/vocab/validation": !0
}, F$ = "meta", z$ = "Validation vocabulary meta-schema", U$ = [
  "object",
  "boolean"
], q$ = {
  type: {
...
const H$ = Fp, B$ = Wp, J$ = r$, W$ = u$, X$ = _$, Y$ = R$, Q$ = D$, Z$ = K$, x$ = ["/properties"];
function ey(e) {
  return [
    H$,
    B$,
  ...
  function t(r, n) {
    return e ? r.$dataMetaSchema(n, x$) : n;
  }
}
ao.default = ey;
(function(e, t) {
  Object.defineProperty(t, "__esModule", { value: !0 }), t.MissingRefError = t.ValidationError = t.CodeGen = t.Name = t.nil = t.stringify = t.str = t._ = t.KeywordCxt = t.Ajv2020 = void 0;
  const r = Vc, n = ga, s = so, a = ao, o = "https://json-schema.org/draft/2020-12/schema";
...
var ty = Ls.exports, Hs = { exports: {} }, bl = {};
(function(e) {
...
var Sl = {}, Bs = { exports: {} }, Pl = {}, st = {}, yr = {}, nn = {}, oe = {}, xr = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.regexpCode = e.getEsmExportName = e.getProperty = e.safeStringify = e.stringify = e.strConcat = e.addCodeArg = e.str = e._ = e.nil = e._Code = e.Name = e.IDENTIFIER = e._CodeOrName = void 0;
  class t {
  }
...
F.schemaHasRulesButRef = ay;
function oy({ topSchemaRef: e, schemaPath: t }, r, n, s) {
  if (!s) {
    if (typeof r == "number" || typeof r == "boolean")
      return r;
    if (typeof r == "string")
...
function uy(e, t) {
  return e.scopeValue("func", {
    ref: t,
    code: Fi[t.code] || (Fi[t.code] = new ry._Code(t.code))
  });
}
F.useFunc = uy;
var Ws;
...
const hy = nn, my = oe, py = mt, $y = {
  message: "boolean schema is false"
};
function yy(e) {
  const { gen: t, schema: r, validateName: n } = e;
  r === !1 ? kl(e, !1) : typeof r == "object" && r.$async === !0 ? t.return(py.default.data) : (t.assign((0, my._)`${n}.errors`, null), t.return(!0));
}
yr.topBoolOrEmptySchema = yy;
function gy(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), kl(e)) : r.var(t, !0);
}
yr.boolOrEmptySchema = gy;
function kl(e, t) {
  ...
  (0, hy.reportError)(s, $y, void 0, t);
}
var Se = {}, tr = {};
Object.defineProperty(tr, "__esModule", { value: !0 });
tr.getRules = tr.isJSONType = void 0;
const _y = ["string", "number", "integer", "boolean", "null", "object", "array"], vy = new Set(_y);
function wy(e) {
...
function by({ schema: e, self: t }, r) {
  const n = t.RULES.types[r];
  return n && n !== !0 && Tl(e, n);
}
wt.schemaHasRulesForType = by;
function Tl(e, t) {
  return t.rules.some((r) => Al(e, r));
}
wt.shouldUseGroup = Tl;
function Al(e, t) {
  var r;
  return e[t.keyword] !== void 0 || ((r = t.definition.implements) === null || r === void 0 ? void 0 : r.some((n) => e[n] !== void 0));
}
...
const Sy = tr, Py = wt, Ny = nn, se = oe, Cl = F;
var mr;
(function(e) {
  e[e.Correct = 0] = "Correct", e[e.Wrong = 1] = "Wrong";
})(mr || (Se.DataType = mr = {}));
...
Se.getSchemaTypes = Ry;
function Dl(e) {
  const t = Array.isArray(e) ? e : e ? [e] : [];
  if (t.every(Sy.isJSONType))
    return t;
  throw new Error("type must be JSONType or JSONType[]: " + t.join(","));
}
Se.getJSONTypes = Dl;
function Oy(e, t) {
  const { gen: r, data: n, opts: s } = e, a = Iy(t, s.coerceTypes), o = t.length > 0 && !(a.length === 0 && t.length === 1 && (0, Py.schemaHasRulesForType)(e, t[0]));
  if (o) {
    const c = co(t, n, s.strictNumbers, mr.Wrong);
    r.if(c, () => {
      a.length ? jy(e, t, a) : lo(e);
    });
  }
  return o;
}
Se.coerceAndCheckDataType = Oy;
...
function jy(e, t, r) {
  ...
  a.coerceTypes === "array" && n.if((0, se._)`${o} == 'object' && Array.isArray(${s}) && ${s}.length == 1`, () => n.assign(s, (0, se._)`${s}[0]`).assign(o, (0, se._)`typeof ${s}`).if(co(t, s, a.strictNumbers), () => n.assign(c, s))), n.if((0, se._)`${c} !== undefined`);
  for (const d of r)
    (Ml.has(d) || d === "array" && a.coerceTypes === "array") && l(d);
  n.else(), lo(e), n.endIf(), n.if((0, se._)`${c} !== undefined`, () => {
    n.assign(s, c), ky(e, c);
  });
  function l(d) {
    switch (d) {
...
function ky({ gen: e, parentData: t, parentDataProperty: r }, n) {
...
function zi(e, t, r) {
  ...
  if (s) {
    (0, Cy.checkStrictMode)(e, `default is ignored for: ${c}`);
    return;
  }
...
ce.propertyInData = zy;
function ho(e, t, r, n) {
  const s = (0, pe._)`${t}${(0, pe.getProperty)(r)} === undefined`;
  return n ? (0, pe.or)(s, (0, pe.not)(fo(e, t, r))) : s;
}
ce.noPropertyInData = ho;
function Vl(e) {
  return e ? Object.keys(e).filter((t) => t !== "__proto__") : [];
}
ce.allSchemaProperties = Vl;
function Uy(e, t) {
  return Vl(t).filter((r) => !(0, uo.alwaysValidSchema)(e, t[r]));
}
ce.schemaProperties = Uy;
function qy({ schemaCode: e, data: t, it: { gen: r, topSchemaRef: n, schemaPath: s, errorPath: a }, it: o }, c, l, d) {
...
ce.callValidateCode = qy;
const Gy = (0, pe._)`new RegExp`;
function Ky({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, a = s(r, n);
  return e.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, pe._)`${s.code === "new RegExp" ? Gy : (0, My.useFunc)(e, s)}(${r}, ${n})`
  });
}
ce.usePattern = Ky;
function Hy(e) {
...
function Yy(e, t) {
  ...
  function w() {
    if (t.errors === !1)
      g(), t.modifying && Ui(e), _(() => e.error());
    else {
      const m = t.async ? $() : y();
      t.modifying && Ui(e), _(() => Qy(e, m));
    }
  }
  function $() {
  ...
  function g(m = t.async ? (0, Ve._)`await ` : Ve.nil) {
    const E = l.opts.passContext ? Yt.default.this : Yt.default.self, P = !("compile" in t && !c || t.schema === !1);
    n.assign(h, (0, Ve._)`${m}${(0, Jy.callValidateCode)(e, u, E, P)}`, t.modifying);
  }
  function _(m) {
    var E;
...
function Qy(e, t) {
  ...
  r.if((0, Ve._)`Array.isArray(${t})`, () => {
    r.assign(Yt.default.vErrors, (0, Ve._)`${Yt.default.vErrors} === null ? ${t} : ${Yt.default.vErrors}.concat(${t})`).assign(Yt.default.errors, (0, Ve._)`${Yt.default.vErrors}.length`), (0, Wy.extendErrors)(e);
  }, () => e.error());
}
function Zy({ schemaEnv: e }, t) {
  if (t.async && !e.$async)
    throw new Error("async keyword in sync schema");
}
function Fl(e, t, r) {
...
ht.validSchemaType = xy;
function eg({ schema: e, opts: t, self: r, errSchemaPath: n }, s, a) {
...
ht.validateKeywordUsage = eg;
var Ft = {};
Object.defineProperty(Ft, "__esModule", { value: !0 });
Ft.extendSubschemaMode = Ft.extendSubschemaData = Ft.getSubschema = void 0;
const dt = oe, zl = F;
function tg(e, { keyword: t, schemaProp: r, schema: n, schemaPath: s, errSchemaPath: a, topSchemaRef: o }) {
...
Ft.getSubschema = tg;
function rg(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  if (s !== void 0 && r !== void 0)
    throw new Error('both "data" and "dataProp" passed, only one allowed');
  const { gen: c } = t;
  if (r !== void 0) {
    const { errorPath: d, dataPathArr: u, opts: h } = t, w = c.let("data", (0, dt._)`${t.data}${(0, dt.getProperty)(r)}`, !0);
    l(w), e.errorPath = (0, dt.str)`${d}${(0, zl.getErrorPath)(r, n, h.jsPropertySyntax)}`, e.parentDataProperty = (0, dt._)`${r}`, e.dataPathArr = [...u, e.parentDataProperty];
  }
  if (s !== void 0) {
...
function ng(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), a !== void 0 && (e.allErrors = a), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Ft.extendSubschemaMode = ng;
var ke = {}, Ul = { exports: {} }, Mt = Ul.exports = function(e, t, r) {
  typeof t == "function" && (r = t, t = {}), r = t.cb || r;
  var n = typeof r == "function" ? r : r.pre || function() {
  }, s = r.post || function() {
  };
  ...
  if (n && typeof n == "object" && !Array.isArray(n)) {
    ...
    for (var u in n) {
      ...
      if (Array.isArray(h)) {
        ...
        if (h && typeof h == "object")
          for (var $ in h)
            Tn(e, t, r, h[$], s + "/" + u + "/" + sg($), a, s, u, n, $);
      } else (u in Mt.keywords || e.allKeys && !(u in Mt.skipKeywords)) && Tn(e, t, r, h, s + "/" + u, a, s, u, n);
    }
    r(n, s, a, o, c, l, d);
  }
}
...
const og = F, ig = xn, cg = ag, lg = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function ug(e, t = !0) {
  return typeof e == "boolean" ? !0 : t === !0 ? !Ys(e) : t ? ql(e) <= t : !1;
}
ke.inlineRef = ug;
...
function ql(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !lg.has(r) && (typeof e[r] == "object" && (0, og.eachItem)(e[r], (n) => t += ql(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
function pg(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = pr(e[r] || t), a = { "": s }, o = Gl(n, s, !1), c = {}, l = /* @__PURE__ */ new Set();
...
const Hl = yr, qi = Se, mo = wt, Kn = Se, $g = is, Br = ht, Ps = Ft, W = oe, x = mt, yg = ke, Et = F, Mr = nn;
function gg(e) {
  if (Wl(e) && (Xl(e), Jl(e))) {
    wg(e);
    return;
...
function Bl({ gen: e, validateName: t, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? e.func(t, (0, W._)`${x.default.data}, ${x.default.valCxt}`, n.$async, () => {
    e.code((0, W._)`"use strict"; ${Gi(r, s)}`), vg(e, s), e.code(a);
  }) : e.func(t, (0, W._)`${x.default.data}, ${_g(s)}`, n.$async, () => e.code(Gi(r, s)).code(a));
}
function _g(e) {
...
function wg(e) {
  ...
  Bl(e, () => {
    r.$comment && t.$comment && Ql(e), Ng(e), n.let(x.default.vErrors, null), n.let(x.default.errors, 0), r.unevaluated && Eg(e), Yl(e), Ig(e);
  });
}
function Eg(e) {
...
function Sg(e, t) {
  ...
  s.$comment && r.$comment && Ql(e), Rg(e), Og(e);
  const a = n.const("_errs", x.default.errors);
  Yl(e, a), n.var(t, (0, W._)`${a} === ${x.default.errors}`);
}
function Xl(e) {
  (0, Et.checkUnknownRules)(e), Pg(e);
}
function Yl(e, t) {
  if (e.opts.jtd)
    return Ki(e, [], !1, t);
...
function Rg(e) {
  ...
  t && (e.baseId = (0, yg.resolveUrl)(e.opts.uriResolver, e.baseId, t));
}
function Og(e) {
...
function Ig(e) {
  ...
  r.$async ? t.if((0, W._)`${x.default.errors} === 0`, () => t.return(x.default.data), () => t.throw((0, W._)`new ${s}(${x.default.vErrors})`)) : (t.assign((0, W._)`${n}.errors`, x.default.vErrors), a.unevaluated && jg(e), t.return((0, W._)`${x.default.errors} === 0`));
}
function jg({ gen: e, evaluated: t, props: r, items: n }) {
...
function Ki(e, t, r, n) {
  ...
  l.jtd || kg(e, t), s.block(() => {
    for (const w of u.rules)
      h(w);
    h(u.post);
  });
  function h(w) {
    (0, mo.shouldUseGroup)(a, w) && (w.type ? (s.if((0, Kn.checkDataType)(w.type, o, l.strictNumbers)), Hi(e, w), t.length === 1 && t[0] === w.type && r && (s.else(), (0, Kn.reportTypeError)(e)), s.endIf()) : Hi(e, w), c || s.if((0, W._)`${x.default.errors} === ${n || 0}`));
  }
}
function Hi(e, t) {
  const { gen: r, schema: n, opts: { useDefaults: s } } = e;
  s && (0, $g.assignDefaults)(e, t.type), r.block(() => {
    for (const a of t.rules)
      (0, mo.shouldUseRule)(n, a) && eu(e, a.keyword, a.definition, t.type);
  });
}
function kg(e, t) {
  e.schemaEnv.meta || !e.opts.strictTypes || (Tg(e, t), e.opts.allowUnionTypes || Ag(e, t), Cg(e, e.dataTypes));
}
function Tg(e, t) {
  if (t.length) {
...
const Ze = oe, Ug = sn, Bt = mt, rt = ke, Bi = F, qg = st;
class cs {
  constructor(t) {
    var r;
    this.refs = {}, this.dynamicAnchors = {};
...
Ge.resolveRef = Gg;
function Kg(e) {
  return (0, rt.inlineRef)(e.schema, this.opts.inlineRefs) ? e.schema : e.validate ? e : $o.call(this, e);
}
function ru(e) {
  for (const t of this._compilations)
    if (Hg(t, e))
...
function ls(e, t) {
  ...
  if (typeof (o == null ? void 0 : o.schema) == "object") {
    if (o.validate || $o.call(this, o), a === (0, rt.normalizeId)(t)) {
      const { schema: c } = o, { schemaId: l } = this.opts, d = c[l];
...
function Rs(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const c of e.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const l = r[(0, Bi.unescapeFragment)(c)];
    if (l === void 0)
      return;
    r = l;
    const d = typeof r == "object" && r[this.opts.schemaId];
    !Jg.has(c) && d && (t = (0, rt.resolveUrl)(this.opts.uriResolver, t, d));
  }
  let a;
...
(function(e) {
  ...
  const n = sn, s = Sr, a = tr, o = Ge, c = oe, l = ke, d = Se, u = F, h = e0, w = yo, $ = (N, p) => new RegExp(N, p);
  $.code = "new RegExp";
  const y = ["removeAdditional", "useDefaults", "coerceTypes"], g = /* @__PURE__ */ new Set([
    "validate",
    "serialize",
...
const r0 = Sr, Ji = ce, qe = oe, ar = mt, Wi = Ge, pn = F, n0 = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    const { gen: t, schema: r, it: n } = e, { baseId: s, schemaEnv: a, validateName: o, opts: c, self: l } = n, { root: d } = a;
...
function An(e, t, r, n) {
  ...
  function u() {
    ...
    const y = s.let("valid");
    s.try(() => {
      s.code((0, qe._)`await ${(0, Ji.callValidateCode)(e, t, d)}`), $(t), o || s.assign(y, !0);
    }, (g) => {
      s.if((0, qe._)`!(${g} instanceof ${a.ValidationError})`, () => s.throw(g)), w(g), o || s.assign(y, !1);
    }), e.ok(y);
  }
  function h() {
    e.result((0, Ji.callValidateCode)(e, t, d), () => $(t), () => w(t));
  }
  function w(y) {
...
var wo = {}, Eo = {};
Object.defineProperty(Eo, "__esModule", { value: !0 });
const Hn = oe, kt = Hn.operators, Bn = {
...
const Qt = oe, d0 = F, f0 = Po, h0 = {
  ...
  error: h0,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? Qt.operators.GT : Qt.operators.LT, o = s.opts.unicode === !1 ? (0, Qt._)`${r}.length` : (0, Qt._)`${(0, d0.useFunc)(e.gen, f0.default)}(${r})`;
...
const Os = Se, Ie = oe, P0 = F, N0 = an, R0 = {
  ...
  code(e) {
    ...
    function $(y, g) {
      const _ = (0, P0.useFunc)(t, N0.default), m = t.name("outer");
...
const Qs = oe, I0 = F, j0 = an, k0 = {
  ...
  code(e) {
    const { gen: t, data: r, $data: n, schemaCode: s, schema: a } = e;
    n || a && typeof a == "object" ? e.fail$data((0, Qs._)`!${(0, I0.useFunc)(t, j0.default)}(${r}, ${s})`) : e.fail((0, Qs._)`${a} !== ${r}`);
  }
};
ko.default = T0;
var To = {};
Object.defineProperty(To, "__esModule", { value: !0 });
const Ur = oe, A0 = F, C0 = an, D0 = {
  message: "must be equal to one of the allowed values",
...
const L0 = Eo, V0 = bo, F0 = So, z0 = No, U0 = Ro, q0 = Oo, G0 = Io, K0 = jo, H0 = ko, B0 = To, J0 = [
  // number
  L0.default,
  V0.default,
  // string
...
const Xi = oe, Cn = F, Y0 = ce, Q0 = {
  ...
  code(e) {
    ...
    r.items = !0, !(0, Cn.alwaysValidSchema)(r, t) && e.ok((0, Y0.validateArray)(e));
  }
};
function cu(e, t, r = e.schema) {
  ...
  r.forEach((h, w) => {
    (0, Cn.alwaysValidSchema)(c, h) || (n.if((0, Xi._)`${d} > ${w}`, () => e.subschema({
      keyword: o,
      schemaProp: w,
      dataProp: w
    }, l)), e.ok(l));
...
const Yi = oe, e_ = F, t_ = ce, r_ = Pr, n_ = {
...
const yn = ce, et = oe, u_ = mt, gn = F, d_ = {
  message: "must NOT have additional properties",
  ...
  code(e) {
    ...
    function w(_) {
      ...
      return u.length && (m = (0, et.or)(m, ...u.map((E) => (0, et._)`${(0, yn.usePattern)(e, E)}.test(${_})`))), (0, et.not)(m);
    }
    function $(_) {
...
var Vo = {};
Object.defineProperty(Vo, "__esModule", { value: !0 });
const h_ = st, Qi = ce, Is = F, Zi = us, m_ = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: a } = e;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && Zi.default.code(new h_.KeywordCxt(a, Zi.default, "additionalProperties"));
    ...
    const l = t.name("valid");
    for (const h of c)
      d(h) ? u(h) : (t.if((0, Qi.propertyInData)(t, s, h, a.opts.ownProperties)), u(h), a.allErrors || t.else().var(l, !0), t.endIf()), e.it.definedProperties.add(h), e.ok(l);
    function d(h) {
      return a.opts.useDefaults && !a.compositeRule && r[h].default !== void 0;
    }
    function u(h) {
...
const xi = ce, _n = oe, ec = F, tc = F, p_ = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, data: n, parentSchema: s, it: a } = e, { opts: o } = a, c = (0, xi.allSchemaProperties)(r), l = c.filter((g) => (0, ec.alwaysValidSchema)(a, r[g]));
    if (c.length === 0 || l.length === c.length && (!a.opts.unevaluated || a.props === !0))
      return;
    const d = o.strictSchema && !o.allowMatchingProperties && s.properties, u = t.name("valid");
    ...
    function $(g) {
      for (const _ in d)
        new RegExp(g).test(_) && (0, ec.checkStrictMode)(a, `property ${_} matches pattern ${g} (use allowMatchingProperties)`);
    }
    function y(g) {
      t.forIn("key", n, (_) => {
        t.if((0, _n._)`${(0, xi.usePattern)(e, g)}.test(${_})`, () => {
          const m = l.includes(g);
          m || e.subschema({
            keyword: "patternProperties",
            schemaProp: g,
...
Ho.default = O_;
Object.defineProperty(Ao, "__esModule", { value: !0 });
const I_ = Pr, j_ = Co, k_ = Nr, T_ = Do, A_ = Mo, C_ = lu, D_ = Lo, M_ = us, L_ = Vo, V_ = Fo, F_ = zo, z_ = Uo, U_ = qo, q_ = Go, G_ = Ko, K_ = Ho;
function H_(e = !1) {
  const t = [
    // any
    F_.default,
  ...
  return e ? t.push(j_.default, T_.default) : t.push(I_.default, k_.default), t.push(A_.default), t;
}
Ao.default = H_;
var Bo = {}, Jo = {};
Object.defineProperty(Jo, "__esModule", { value: !0 });
...
Object.defineProperty(go, "__esModule", { value: !0 });
const Y_ = _o, Q_ = wo, Z_ = Ao, x_ = Bo, nc = gr, ev = [
  Y_.default,
  Q_.default,
  (0, Z_.default)(),
  x_.default,
...
Object.defineProperty(Wo, "__esModule", { value: !0 });
const ur = oe, xs = ds, ac = Ge, tv = Sr, rv = F, nv = {
  ...
  code(e) {
    ...
    function w() {
      ...
      for (let O = 0; O < o.length; O++) {
        let j = o[O];
        if (j != null && j.$ref && !(0, rv.schemaHasRulesButRef)(j, a.self.RULES)) {
          const Y = j.$ref;
          if (j = ac.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, Y), j instanceof ac.SchemaEnv && (j = j.schema), j === void 0)
...
(function(e, t) {
  ...
  const r = Pl, n = go, s = Wo, a = dv, o = ["/properties"], c = "http://json-schema.org/draft-07/schema";
...
(function(e) {
  ...
  const t = fv, r = oe, n = r.operators, s = {
...
(function(e, t) {
  ...
  const r = bl, n = Sl, s = oe, a = new s.Name("fullFormats"), o = new s.Name("fastFormats"), c = (d, u = { keywords: !0 }) => {
    if (Array.isArray(u))
...
var hv = Hs.exports;
const mv = /* @__PURE__ */ Lc(hv), pv = (e, t, r, n) => {
...
var ea = { exports: {} };
const bv = "2.0.0", fu = 256, Sv = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, Pv = 16, Nv = fu - 6, Rv = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var on = ea.exports;
const Iv = Object.freeze({ loose: !0 }), jv = Object.freeze({}), kv = (e) => e ? typeof e != "object" ? Iv : e : jv;
var Xo = kv;
const ic = /^[0-9]+$/, hu = (e, t) => {
...
const vn = hs, { MAX_LENGTH: cc, MAX_SAFE_INTEGER: wn } = fs, { safeRe: En, t: bn } = on, Av = Xo, { compareIdentifiers: or } = mu;
let Cv = class ut {
  constructor(t, r) {
...
var Uv = zv;
const uc = ze, qv = (e, t, r, n, s) => {
  typeof r == "string" && (s = n, n = r, r = void 0);
  try {
    return new uc(
      e instanceof uc ? e.version : e,
      r
    ).inc(t, n, s).version;
  } catch {
    return null;
...
var nw = rw;
const fc = ze, sw = (e, t, r) => new fc(e, r).compare(new fc(t, r));
var it = sw;
const aw = it, ow = (e, t, r) => aw(t, e, r);
var iw = ow;
const cw = it, lw = (e, t) => cw(e, t, !0);
var uw = lw;
const hc = ze, dw = (e, t, r) => {
  const n = new hc(e, r), s = new hc(t, r);
...
var xo = Iw;
const jw = pu, kw = $u, Tw = ms, Aw = Zo, Cw = Qo, Dw = xo, Mw = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var yu = Mw;
const Lw = ze, Vw = Rr, { safeRe: Sn, t: Pn } = on, Fw = (e, t) => {
  if (e instanceof Lw)
    return e;
...
function ct() {
  ...
  js = t;
  const r = qw, n = new r(), s = Xo, a = ps(), o = hs, c = ze, {
    safeRe: l,
    t: d,
    comparatorTrimReplace: u,
    tildeTrimReplace: h,
    caretTrimReplace: w
  } = on, { FLAG_INCLUDE_PRERELEASE: $, FLAG_LOOSE: y } = fs, g = (k) => k.value === "<0.0.0-0", _ = (k) => k.value === "", m = (k, D) => {
    let U = !0;
    const V = k.slice();
    let J = V.pop();
    for (; U && V.length; )
...
function ps() {
  ...
  ks = t;
  const r = Xo, { safeRe: n, t: s } = on, a = yu, o = hs, c = ze, l = ct();
  return ks;
}
...
var iE = oE;
const cE = ze, gu = ps(), { ANY: lE } = gu, uE = ct(), dE = $s, yc = ms, gc = Qo, fE = xo, hE = Zo, mE = (e, t, r, n) => {
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let h = null, w = null;
    if (u.forEach(($) => {
      $.semver === lE && ($ = new gu(">=0.0.0")), h = h || $, w = w || $, s($.semver, h.semver, n) ? h = $ : o($.semver, w.semver, n) && (w = $);
...
var vE = _E;
const _c = ct(), wE = (e, t, r) => (e = new _c(e, r), t = new _c(t, r), e.intersects(t, r));
var EE = wE;
const bE = $s, SE = it;
var PE = (e, t, r) => {
  const n = [];
...
const vc = ct(), ti = ps(), { ANY: As } = ti, Vr = $s, ri = it, NE = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, RE = [new ti(">=0.0.0-0")], wc = [new ti(">=0.0.0")], OE = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === As) {
    if (t.length === 1 && t[0].semver === As)
      return !0;
    r.includePrerelease ? e = RE : e = wc;
  }
  if (t.length === 1 && t[0].semver === As) {
  ...
  let s, a;
  for (const $ of e)
    $.operator === ">" || $.operator === ">=" ? s = Ec(s, $, r) : $.operator === "<" || $.operator === "<=" ? a = bc(a, $, r) : n.add($.semver);
  if (n.size > 1)
    return null;
  let o;
  if (s && a) {
...
var IE = NE;
const Cs = on, Sc = fs, jE = ze, Pc = mu, kE = Rr, TE = Vv, AE = Uv, CE = Gv, DE = Hv, ME = Wv, LE = Qv, VE = ew, FE = nw, zE = it, UE = iw, qE = uw, GE = Yo, KE = mw, HE = yw, BE = ms, JE = Qo, WE = pu, XE = $u, YE = Zo, QE = xo, ZE = yu, xE = zw, eb = ps(), tb = ct(), rb = $s, nb = Jw, sb = Qw, ab = tE, ob = sE, ib = iE, cb = ei, lb = yE, ub = vE, db = EE, fb = PE, hb = IE;
var mb = {
  parse: kE,
  valid: TE,
  clean: AE,
  ...
  src: Cs.src,
  tokens: Cs.t,
  SEMVER_SPEC_VERSION: Sc.SEMVER_SPEC_VERSION,
  RELEASE_TYPES: Sc.RELEASE_TYPES,
  compareIdentifiers: Pc.compareIdentifiers,
  rcompareIdentifiers: Pc.rcompareIdentifiers
};
const ir = /* @__PURE__ */ Lc(mb), pb = Object.prototype.toString, $b = "[object Uint8Array]", yb = "[object ArrayBuffer]";
function _u(e, t, r) {
  return e ? e.constructor === t ? !0 : pb.call(e) === r : !1;
}
function vu(e) {
  return _u(e, Uint8Array, $b);
}
function gb(e) {
  return _u(e, ArrayBuffer, yb);
}
function _b(e) {
  return vu(e) || gb(e);
}
...
function Rc(e, t = "utf8") {
  return wb(e), Nn[t] ?? (Nn[t] = new globalThis.TextDecoder(t)), Nn[t].decode(e);
}
function Eb(e) {
  if (typeof e != "string")
...
const Sb = mv.default, Oc = "aes-256-cbc", cr = () => /* @__PURE__ */ Object.create(null), Pb = (e) => e != null, Nb = (e, t) => {
...
class Rb {
  constructor(t = {}) {
    ...
    if (Tr(this, He, r), r.schema ?? r.ajvOptions ?? r.rootSchema) {
      if (r.schema && typeof r.schema != "object")
        throw new TypeError("The `schema` option must be an object.");
      const o = new ty.Ajv2020({
        allErrors: !0,
        useDefaults: !0,
        ...r.ajvOptions
      });
      ...
      Tr(this, Ct, o.compile(c));
      for (const [l, d] of Object.entries(r.schema ?? {}))
        d != null && d.default && ($e(this, _t)[l] = d.default);
    }
    r.defaults && Tr(this, _t, {
      ...$e(this, _t),
      ...r.defaults
    }), r.serialize && (this._serialize = r.serialize), r.deserialize && (this._deserialize = r.deserialize), this.events = new EventTarget(), Tr(this, gt, r.encryptionKey);
  ...
  set(t, r) {
    ...
    const { store: n } = this, s = (a, o) => {
      Nb(a, o), $e(this, He).accessPropertiesByDotNotation ? ai(n, a, o) : n[a] = o;
    };
    if (typeof t == "object") {
      const a = t;
  ...
  has(t) {
    return $e(this, He).accessPropertiesByDotNotation ? Tu(this.store, t) : t in this.store;
  }
  /**
  ...
  reset(...t) {
    for (const r of t)
      Pb($e(this, _t)[r]) && this.set(r, $e(this, _t)[r]);
  }
  delete(t) {
    const { store: r } = this;
    $e(this, He).accessPropertiesByDotNotation ? ku(r, t) : delete r[t], this.store = r;
  }
  /**
      Delete all items.
  ...
  get store() {
    try {
      const t = ae.readFileSync(this.path, $e(this, gt) ? null : "utf8"), r = this._encryptData(t), n = this._deserialize(r);
  ...
  *[Symbol.iterator]() {
  ...
  _encryptData(t) {
    if (!$e(this, gt))
      return typeof t == "string" ? t : Rc(t);
    try {
      const r = t.slice(0, 16), n = Ar.pbkdf2Sync($e(this, gt), r.toString(), 1e4, 32, "sha512"), s = Ar.createDecipheriv(Oc, n, r), a = t.slice(17), o = typeof a == "string" ? Ds(a) : a;
      return Rc(Nc([s.update(o), s.final()]));
    } catch {
    }
    return t.toString();
  }
  ...
  _write(t) {
    ...
    if ($e(this, gt)) {
      const n = Ar.randomBytes(16), s = Ar.pbkdf2Sync($e(this, gt), n.toString(), 1e4, 32, "sha512"), a = Ar.createCipheriv(Oc, s, n);
      r = Nc([n, Ds(":"), a.update(Ds(r)), a.final()]);
    }
    if (Pe.env.SNAP)
      ae.writeFileSync(this.path, r, { mode: $e(this, He).configFileMode });
    else
      try {
        Mc(this.path, r, { mode: $e(this, He).configFileMode });
      } catch (n) {
  ...
  _watch() {
    this._ensureDirectory(), ae.existsSync(this.path) || this._write(cr()), Pe.platform === "win32" ? ae.watch(this.path, { persistent: !1 }, oc(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 100 })) : ae.watchFile(this.path, { persistent: !1 }, oc(() => {
      this.events.dispatchEvent(new Event("change"));
    }, { wait: 5e3 }));
  }
  _migrate(t, r, n) {
...
const { app: Ln, ipcMain: ta, shell: Ob } = Tc;
let Ic = !1;
const jc = () => {
  if (!ta || !Ln)
...
class Ib extends Rb {
  constructor(t) {
    let r, n;
    if (Pe.type === "renderer") {
      const s = Tc.ipcRenderer.sendSync("electron-store-get-data");
      if (!s)
        throw new Error("Electron Store: You need to call `.initRenderer()` from the main process.");
      ({ defaultCwd: r, appVersion: n } = s);
    } else ta && Ln && ({ defaultCwd: r, appVersion: n } = jc());
    t = {
      name: "config",
      ...t
...
const zt = Z.dirname(Ru(import.meta.url));
process.env.APP_ROOT = Z.join(zt, "..");
const ra = process.env.VITE_DEV_SERVER_URL, Bb = Z.join(process.env.APP_ROOT, "dist-electron"), wu = Z.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ra ? Z.join(process.env.APP_ROOT, "public") : wu;
let ee, Qr = null;
...
at.handle("save-data", async (e, t, r) => {
  try {
    if (t === "all")
      Vn.set("formData", r);
    else {
...
at.handle("select-folder", async () => {
  const e = await Ac.showOpenDialog(ee, {
...
at.handle("clean-db", async () => (console.log("Limpando banco de dados..."), new Promise((e) => {
  setTimeout(() => {
    console.log("Banco de dados limpo com sucesso"), e(!0);
  }, 1e3);
})));
at.handle("print-pdf", async (e, t) => {
  try {
    const r = new na({
      width: 800,
      height: 600,
...
at.handle("start-fork", async (e, { script: t, args: r = [] } = {}) => {
  const n = Z.dirname(Z.dirname(zt));
  ...
  if (Z.isAbsolute(t))
    ...
    const a = [
      ...
      Z.join(Z.dirname(zt), t),
      Z.join(n, t),
      Z.resolve(t)
    ];
    console.log("Trying paths:", a), s = a.find((o) => {
      try {
        const c = We.existsSync(o);
  ...
  console.log("Attempting to fork script at:", s), console.log("Script exists:", We.existsSync(s));
  try {
  ...
  try {
    ...
    for (; o && o !== Z.dirname(o); ) {
      ...
      if (We.existsSync(u))
        try {
          if (JSON.parse(We.readFileSync(u, "utf8")).name === "backend") {
            c = !0;
            break;
          }
        } catch {
    ...
    c || (o = a), console.log("Setting child process cwd to:", o), Qr = s;
    const l = Qn(s, r, {
      stdio: ["pipe", "pipe", "ipc"],
      cwd: o,
      silent: !1,
    ...
    if (console.log("Child process forked with PID:", d), typeof d == "number")
      nt.set(d, l), console.log("Child process added to children map. Total children:", nt.size);
    else
    ...
    return new Promise((u, h) => {
      ...
      l.on("message", $), l.on("error", (y) => {
        console.error("Child process error:", y), typeof l.pid == "number" && nt.delete(l.pid), clearTimeout(w), h(y);
      }), l.on("exit", (y, g) => {
        console.log(`Child process ${l.pid} exited with code ${y} and signal ${g}`), typeof l.pid == "number" && nt.delete(l.pid), ee && !ee.isDestroyed() && ee.webContents.send("child-exit", { pid: l.pid, code: y, signal: g }), clearTimeout(w), h(new Error(`Child process exited with code ${y}`));
      }), l.on("message", (y) => {
        ...
        console.log("Child stdout:", y.toString()), ee && !ee.isDestroyed() && ee.webContents.send("child-stdout", { pid: l.pid, data: y.toString() });
      }), l.stderr && l.stderr.on("data", (y) => {
        console.error("Child stderr:", y.toString()), ee && !ee.isDestroyed() && ee.webContents.send("child-stderr", { pid: l.pid, data: y.toString() });
      });
    });
  } catch (a) {
...
at.handle("start-collector-fork", async (e, { args: t = [] } = {}) => {
  const r = Z.dirname(Z.dirname(zt)), n = [
    Z.join(r, "back-end", "dist", "src", "collector", "runner.js"),
    Z.join(r, "back-end", "dist", "collector", "runner.js"),
    Z.join(r, "back-end", "src", "collector", "runner.ts")
  ], s = n.find((a) => We.existsSync(a)) || n[0];
  if (!We.existsSync(s)) return { ok: !1, reason: "collector-not-found", attempted: n };
  try {
    const a = Qn(s, t, { stdio: ["pipe", "pipe", "ipc"], cwd: Z.dirname(s), env: { ...process.env } }), o = a.pid;
    return typeof o == "number" && (nt.set(o, a), a.on("message", (c) => {
...
at.handle("send-to-child", async (e, { pid: t, msg: r } = {}) => {
  if (console.log("send-to-child called with PID:", t, "Message type:", r == null ? void 0 : r.type), console.log("Available children PIDs:", Array.from(nt.keys())), typeof t != "number") return { ok: !1, reason: "invalid-pid" };
  const n = nt.get(t);
  if (!n) {
    if (console.log("Child not found for PID:", t), Qr)
      try {
        const s = Z.dirname(Qr), a = Qn(Qr, [], { stdio: ["pipe", "pipe", "ipc"], cwd: s, silent: !1, env: { ...process.env } }), o = a.pid;
        if (typeof o == "number") {
          nt.set(o, a), ee && !ee.isDestroyed() && ee.webContents.send("child-message", { pid: o, msg: { type: "event", event: "reforked", payload: { oldPid: t, newPid: o } } });
          try {
...
at.handle("stop-child", async (e, { pid: t } = {}) => {
...
function kc() {
  if (ee = new na({
    ...
    try {
      const e = Z.join(zt, "..", "dist", "index.html");
      if (console.log("[main] loading packaged index from", e), We.existsSync(e))
        ee.loadFile(e);
      else {
        const t = Z.join(wu, "index.html");
        console.warn("[main] packaged index not found at", e, "falling back to", t), ee.loadFile(t);
      }
    } catch (e) {
      console.error("[main] failed to load packaged index.html", e);
      try {
        const t = Z.join(process.resourcesPath, "app.asar", "dist", "index.html");
...
Vt.whenReady().then(() => {
  (async () => {
    if (Vt.isPackaged)
      try {
        const e = Z.join(process.resourcesPath, "backend", "backend.exe");
        We.existsSync(e) ? (console.log("[main] Spawning packaged backend exe at", e), Lt = Ou(e, [], { env: { ...process.env, FRONTEND_API_PORT: process.env.FRONTEND_API_PORT || "3000" }, cwd: process.resourcesPath }), Lt.stdout.on("data", (t) => console.log("[backend exe stdout]", t.toString())), Lt.stderr.on("data", (t) => console.error("[backend exe stderr]", t.toString())), Lt.on("exit", (t) => console.log("[backend exe] exited", t))) : console.warn("[main] packaged backend exe not found at", e);
      } catch (e) {
        console.error("[main] failed to spawn packaged backend exe", e);
      }
    else
      try {
        const e = Z.dirname(Z.dirname(zt)), r = [
          Z.join(e, "back-end", "dist", "index.js"),
          Z.join(e, "back-end", "dist", "src", "index.js"),
          Z.join(e, "back-end", "src", "index.ts")
        ].find((n) => We.existsSync(n));
        if (r)
          try {
            console.log("[main] dev auto-forking backend at", r), Qr = r;
            const n = Z.dirname(r), s = Qn(r, [], { stdio: ["pipe", "pipe", "ipc"], cwd: n, env: { ...process.env } }), a = s.pid;
            typeof a == "number" && (nt.set(a, s), console.log("[main] dev backend forked with PID", a)), s.on("message", (o) => {
              ee && !ee.isDestroyed() && ee.webContents.send("child-message", { pid: s.pid, msg: o });
            }), s.stdout && s.stdout.on("data", (o) => {
              console.log("[child stdout]", o.toString()), ee && !ee.isDestroyed() && ee.webContents.send("child-stdout", { pid: s.pid, data: o.toString() });
            }), s.stderr && s.stderr.on("data", (o) => {
              console.error("[child stderr]", o.toString()), ee && !ee.isDestroyed() && ee.webContents.send("child-stderr", { pid: s.pid, data: o.toString() });
            });
          } catch (n) {
    ...
    na.getAllWindows().length === 0 && kc();
  });
});
Vt.on("window-all-closed", () => {
  process.platform !== "darwin" && Vt.quit();
});
Vt.on("before-quit", () => {
  try {
...
const jb = Z.join(Vt.getPath("userData"), "error.log"), Eu = We.createWriteStream(jb, { flags: "a" });
...
at.handle("save-pdf", async (e, t) => {
  try {
    const r = Vt.getPath("temp"), n = Z.join(r, `relatorio-${Date.now()}.pdf`), s = Buffer.from(t, "base64");
    return We.writeFileSync(n, s), { ok: !0, path: n };
  } catch (r) {
