...
const App = () => {
  ...
  return (
    <div id="app" className="flex w-screen h-dvh overflow-hidden">
      ...
      <div
        id="main-content"
        className="flex flex-1 flex-col overflow-hidden py-2 px-2 md:px-4"
      >
        <Routes>
          ...
          <Route path="*" element={<RequireAuth><h1 className="p-4">404 - Página não encontrada</h1></RequireAuth>} />
        </Routes>
